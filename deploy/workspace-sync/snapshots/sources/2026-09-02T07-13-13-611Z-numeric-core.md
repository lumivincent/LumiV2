...
# HealthMultiplier/MoveRange/ActionSpeedMultiplier/BackpackCapacity = 该阶段对应的 HP 倍率、移动范围、行动速度倍率和背包容量
...
# SourceAgent* = 进入遭遇时锁定的来源 Agent 数值
...
# 参数：
# Profession = 三职业之一
# PetMinimumAttack/Defense = 宠物该职业最低攻防
# StandardLevel1Target* = 标准 Lv1 对象数值
# PetMinimumNormalDamage = 最低配置的普通伤害
# PetMinimumActionsToComplete = 完成标准对象所需行动
# PetMinimumMaximumHealth = 宠物最低最大 HP。
